...
import type { SearchInput, TrademarkAnalysis } from "@/lib/types";
    ...
    <>
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-muted leading-relaxed max-w-md mx-auto">
                  Analysez les risques de conflit pour votre marque grace a
                  notre moteur d&apos;intelligence artificielle. Résultats instantanés,
                  analyse approfondie.
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px]">Données sécurisées</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px]">Couverture internationale</span>
                </div>
              </motion.div>
            </motion.div>
          )}

          {view === "results" && analysis && searchInput && (
            <motion.div
              key="results"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <footer className="relative z-10 border-t border-border/30 py-6 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <span className="text-[10px] text-muted/50">
            Cette analyse ne constitue pas un avis juridique
          </span>
        </div>
      </footer>
    </>
